...
Revision ID: 217c79f2920d
Revises: a66b56d826cd
Create Date: 2022-11-28 09:54:27.750395
...
revision = '217c79f2920d'
down_revision = 'a66b56d826cd'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('tg_id', sa.String(length=65), nullable=True),
